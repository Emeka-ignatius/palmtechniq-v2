...
import { ArrowLeft, FileText, Calendar, Globe, Shield, Users, CreditCard } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-dark-900 via-dark-800 to-dark-900 pt-24">
      <div className="container mx-auto px-6 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <Button variant="ghost" className="mb-6 hover:bg-white/10" onClick={() => window.history.back()}>
                ...
                <CardContent className="p-8 space-y-8">
                  ...
                  <div className="prose prose-invert max-w-none">
                    <p className="text-gray-300 text-lg leading-relaxed">
                      Welcome to LearnForge! These Terms of Service ("Terms") govern your use of our online learning
                      platform and services. By accessing or using LearnForge, you agree to be bound by these Terms.
                    </p>
                  </div>
                  ...
                  <section id="acceptance" className="space-y-4">
                    ...
                    <div className="prose prose-invert max-w-none">
                      <p className="text-gray-300">
                        By creating an account, accessing, or using any part of LearnForge, you acknowledge that you
                        have read, understood, and agree to be bound by these Terms. If you do not agree to these Terms,
                        you may not use our services.
                      </p>
                      <p className="text-gray-300">
                        These Terms apply to all users of the platform, including students, instructors, and
                        administrators. We reserve the right to modify these Terms at any time, and such modifications
                  ...
                  <section id="services" className="space-y-4">
                    ...
                    <div className="prose prose-invert max-w-none">
                      <p className="text-gray-300">LearnForge is an online learning platform that provides:</p>
                  ...
                  <section id="accounts" className="space-y-4">
                    ...
                    <div className="prose prose-invert max-w-none">
                      <p className="text-gray-300">
                        To access certain features of LearnForge, you must create an account. You agree to:
                      </p>
                      <ul className="text-gray-300 space-y-2 ml-6">
                  ...
                  <section id="payments" className="space-y-4">
                    ...
                    <div className="prose prose-invert max-w-none">
                      <p className="text-gray-300">Payment terms for LearnForge services:</p>
                      <ul className="text-gray-300 space-y-2 ml-6">
                        ...
                        <li>• Refunds are subject to our 30-day money-back guarantee</li>
                      </ul>
                      <p className="text-gray-300">
                  ...
                  <section id="content" className="space-y-4">
                    ...
                    <div className="prose prose-invert max-w-none">
                      <p className="text-gray-300">Users are prohibited from:</p>
                      <ul className="text-gray-300 space-y-2 ml-6">
                  ...
                  <section id="privacy" className="space-y-4">
                    ...
                    <div className="prose prose-invert max-w-none">
                      <p className="text-gray-300">
                        ...
                        your information. By using LearnForge, you consent to our data practices as described in our
                        Privacy Policy.
                      </p>
                      <p className="text-gray-300">
                        We implement industry-standard security measures to protect your personal information and course
                        progress data.
                      </p>
                    </div>
                  </section>
                  ...
                  <section id="disclaimers" className="space-y-4">
                    ...
                    <div className="prose prose-invert max-w-none">
                      <p className="text-gray-300">
                        LearnForge is provided "as is" without warranties of any kind. We do not guarantee:
                      </p>
                      <ul className="text-gray-300 space-y-2 ml-6">
                  ...
                  <section id="limitation" className="space-y-4">
                    ...
                    <div className="prose prose-invert max-w-none">
                      <p className="text-gray-300">
                        To the maximum extent permitted by law, LearnForge shall not be liable for any indirect,
                        incidental, special, or consequential damages arising from your use of our services.
                      </p>
                      <p className="text-gray-300">
                        Our total liability shall not exceed the amount you paid for the specific service that gave rise
                        to the claim.
                      </p>
                    </div>
                  </section>
                  ...
                  <section id="contact" className="space-y-4">
                    ...
                    <div className="prose prose-invert max-w-none">
                      <p className="text-gray-300">If you have questions about these Terms, please contact us:</p>
