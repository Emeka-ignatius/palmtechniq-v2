...
import { ArrowLeft, Shield, Eye, Database, Lock, Globe, Users, Settings, FileText, Calendar } from "lucide-react"
                ...
                <CardContent className="p-8 space-y-8">
                  ...
                  <div className="prose prose-invert max-w-none">
                    <p className="text-gray-300 text-lg leading-relaxed">
                      At LearnForge, we are committed to protecting your privacy and ensuring the security of your
                      personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard
                      your information when you use our online learning platform.
                    </p>
                  </div>
                  ...
                  <section id="overview" className="space-y-4">
                    ...
                    <div className="prose prose-invert max-w-none">
                      <p className="text-gray-300">
                        This Privacy Policy applies to all users of LearnForge, including students, instructors, and
                        administrators. We believe in transparency and want you to understand:
                      </p>
                      ...
                      <p className="text-gray-300">
                        We are committed to GDPR compliance and follow industry best practices for data protection.
                      </p>
                    </div>
                  </section>
                  ...
                  <section id="collection" className="space-y-4">
                    ...
                    <div className="prose prose-invert max-w-none">
                      ...
                      <p className="text-gray-300">We collect information you provide directly to us:</p>
                      <ul className="text-gray-300 space-y-2 ml-6">
                  ...
                  <section id="rights" className="space-y-4">
                    ...
                    <div className="prose prose-invert max-w-none">
                      ...
                      <p className="text-gray-300">To exercise these rights, contact us at privacy@learnforge.com.</p>
                    </div>
                  </section>
                  ...
                  <section id="retention" className="space-y-4">
                    ...
                    <div className="prose prose-invert max-w-none">
                      <p className="text-gray-300">We retain your information for as long as necessary to:</p>
                      <ul className="text-gray-300 space-y-2 ml-6">
                  ...
                  <section id="children" className="space-y-4">
                    ...
                    <div className="prose prose-invert max-w-none">
                      <p className="text-gray-300">
                        LearnForge is not intended for children under 13. We do not knowingly collect personal
                    ...
                    <div className="prose prose-invert max-w-none">
                      ...
                      <div className="bg-white/5 p-6 rounded-lg mt-4">
                        <div className="grid md:grid-cols-2 gap-4">
                          <div>
                            <h4 className="font-semibold text-white mb-2">General Privacy Inquiries</h4>
