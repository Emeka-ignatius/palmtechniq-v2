...
export default function StudentAssignments() {
  ...
  const activeAssignments = [
    {
      ...
      points: 100,
      description: "Create a fully functional todo application using React hooks, context API, and local storage.",
      requirements: [
    ...
    },
    {
      ...
      difficulty: "Advanced",
      points: 150,
      description: "Design and implement a RESTful API for a blog application with authentication and CRUD operations.",
      requirements: [
    ...
    },
    {
      ...
      difficulty: "Advanced",
      points: 200,
      description: "Analyze a real-world dataset using Python and machine learning techniques to derive insights.",
      requirements: [
  ...
  const AssignmentCard = ({ assignment, type }: { assignment: any; type: "active" | "completed" }) => (
    <motion.div
        ...
        <CardHeader className="pb-4">
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2">
                <Avatar className="w-6 h-6">
                  <AvatarImage src={assignment.instructorAvatar || "/placeholder.svg"} />
                ...
                <span className="text-gray-400 text-sm">{assignment.instructor}</span>
              </div>
            </div>
            <div className="text-right">
              ...
              {type === "completed" && (
                <>
                  <Badge className="mb-2 bg-green-500/20 text-green-400 border-green-500/30">{assignment.grade}</Badge>
          ...
          {type === "completed" && (
            <>
              <div className="space-y-2">
                ...
                <p className="text-gray-300 text-sm bg-white/5 p-3 rounded-lg">{assignment.feedback}</p>
              </div>

              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <p className="text-gray-400">Submitted</p>
                  <p className="text-white">{new Date(assignment.submittedDate).toLocaleDateString()}</p>
                </div>
                <div>
                ...
                <Dialog>
                  ...
                  <DialogContent className="bg-gray-900 border-white/20 text-white max-w-4xl max-h-[80vh] overflow-y-auto">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-white mb-2">Submit Assignment</h4>
                        <div className="space-y-4">
                          <div>
                            <label className="text-sm font-medium text-white mb-2 block">GitHub Repository URL</label>
                            <Input
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold mb-4">
              <span className="text-white">My</span> <span className="text-gradient">Assignments</span>
            </h1>
            <p className="text-xl text-gray-300">Track your progress and submit your work</p>
          </motion.div>
            ...
            <TabsContent value="active" className="space-y-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {activeAssignments.map((assignment) => (
                  <AssignmentCard key={assignment.id} assignment={assignment} type="active" />
                ))}
              </div>
            </TabsContent>
