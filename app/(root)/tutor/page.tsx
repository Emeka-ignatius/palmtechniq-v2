...
import { BarChart3, Users, BookOpen, Calendar, DollarSign, TrendingUp, Star, Award, Plus } from "lucide-react"
...
export default function TutorDashboard() {
  ...
  const dashboardData = {
    ...
    recentActivity: [
      { type: "enrollment", message: "Mike Johnson enrolled in React Masterclass", time: "2 min ago" },
      { type: "review", message: "New 5-star review from Lisa Rodriguez", time: "15 min ago" },
      { type: "mentorship", message: "Mentorship session completed with Alex Kim", time: "1 hour ago" },
      { type: "project", message: "New project submission from Emma Wilson", time: "2 hours ago" },
    ],
    courses: [
      {
        id: 1,
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold mb-4">
              <span className="text-white">Welcome back,</span> <span className="text-gradient">Sarah!</span>
            </h1>
            <p className="text-xl text-gray-300">Your teaching empire is thriving! Here's what's happening today.</p>
          </motion.div>
          ...
          >
            {[
              { icon: Plus, label: "Create Course", color: "from-neon-blue to-cyan-400" },
              { icon: Calendar, label: "Schedule Mentorship", color: "from-neon-purple to-pink-400" },
              { icon: Award, label: "Create Project", color: "from-neon-green to-emerald-400" },
              { icon: BarChart3, label: "View Analytics", color: "from-neon-orange to-yellow-400" },
            ].map((action, index) => (
              <motion.button
                key={action.label}
                  ...
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className="bg-green-500/20 text-green-400 border-green-500/30">
                        +${dashboardData.stats.monthlyEarnings.toLocaleString()} this month
                      </Badge>
                    </div>
                  </CardHeader>
                  <CardContent>
                    <div className="h-64 bg-gradient-to-r from-neon-blue/10 to-neon-purple/10 rounded-lg flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <p className="text-gray-300">Earnings chart would be rendered here</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-4 mt-1 text-sm text-gray-400">
                            ...
                            <div className="flex items-center">
                              <DollarSign className="w-4 h-4 mr-1 text-green-400" />${course.earnings.toLocaleString()}
                            </div>
                          </div>
                        </div>
                        <div className="text-right">
                          ...
                          <p className="text-gray-400 text-xs mt-1">Updated {course.lastUpdated}</p>
                        </div>
                      </motion.div>
                    ))}
                  </CardContent>
                  ...
                  <CardContent className="space-y-4">
                    {dashboardData.pendingProjects.map((project, index) => (
                      ...
                      >
                        ...
                        <div className="text-right">
                          <Button size="sm" className="bg-gradient-to-r from-neon-blue to-neon-purple text-white">
                            Review
                          </Button>
                          <p className="text-gray-400 text-xs mt-1">Due {project.dueDate}</p>
                        </div>
                      </motion.div>
                    ))}
                  </CardContent>
                    ...
                    {dashboardData.upcomingMentorships.map((session, index) => (
                      <div key={session.id} className="p-4 bg-white/5 rounded-lg">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <Badge className="bg-neon-blue/20 text-neon-blue border-neon-blue/30">${session.price}</Badge>
                        </div>
              ...
              >
                <Card className="glass-card border-white/10">
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-gray-400 text-sm">Course Completion Rate</span>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-gray-400 text-sm">Student Satisfaction</span>
