...
export function FloatingAIButton({ onActivate, isActive = false, lessonProgress = 0 }: FloatingAIButtonProps) {
        ...
        {lessonProgress > 0 && (
          ...
          >
            <svg className="w-16 h-16 transform -rotate-90">
              <circle cx="32" cy="32" r="30" stroke="rgba(59, 130, 246, 0.3)" strokeWidth="2" fill="none" />
              <motion.circle
                cx="32"
                cy="32"
                r="30"
