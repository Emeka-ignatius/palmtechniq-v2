...
export function LiveActivityTicker() {
  const [activities, setActivities] = useState([
    { name: "Sarah M.", action: "enrolled in React Masterclass", time: "2 min ago", location: "San Francisco" },
    { name: "Mike K.", action: "completed Python Bootcamp", time: "5 min ago", location: "New York" },
    { name: "Lisa R.", action: "started AI Interview Prep", time: "8 min ago", location: "London" },
  ])
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  <p className="text-white text-sm font-medium">
                    <span className="text-neon-green">{activities[currentIndex].name}</span>{" "}
                    {activities[currentIndex].action}
                  </p>
                  <p className="text-gray-400 text-xs">
                    {activities[currentIndex].time} • {activities[currentIndex].location}
                  </p>
                </div>
              </div>
            </CardContent>
    ...
    >
      ...
      >
        <div className="flex items-center justify-between p-6 border-b border-white/10">
          <h3 className="text-xl font-bold text-white">Preview: {courseTitle}</h3>
        ...
        <div className="aspect-video bg-gray-800 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-300">Course preview would play here</p>
          </div>
        </div>
      </motion.div>
    </motion.div>
...
export function TrustSignals() {
  const companies = ["Google", "Apple", "Netflix", "Microsoft", "Amazon", "Meta"]
      ...
      <Card className="glass-card border-neon-blue/30 bg-neon-blue/10">
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-4">
            <Badge className="bg-neon-blue/20 text-neon-blue border-neon-blue/30">Success Story</Badge>
          ...
          <p className="text-gray-300 text-sm mb-3">
            "Got promoted to Senior Engineer after completing the React Masterclass. 40% salary increase!"
          </p>
            ...
            <Card className="glass-card border-white/10 h-full">
              <CardContent className="p-0 h-full flex flex-col">
                <div className="p-4 border-b border-white/10">
                  ...
                  <p className="text-gray-400 text-sm">Get instant help choosing the right course</p>
                </div>
                <div className="flex-1 p-4 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-300 text-sm">Chat with our course advisors</p>
                    <p className="text-gray-400 text-xs mt-1">Average response time: 2 minutes</p>
                  </div>
                </div>
              </CardContent>
            </Card>
